          ...
          switch (ev.type) {
            ...
            case 'content_block_start': {
              ...
              if (cb.type === 'text') {
                ...
                // Result arrives fully formed (no deltas) — capture it directly
            ...
            case 'content_block_stop': {
              ...
              if (currentBlock.type === 'tool_use') {
                ...
                try { currentBlock.input = JSON.parse(currentInputBuf || '{}'); } catch (_) { currentBlock.input = {}; }
                assistantBlocks.push({ type: 'server_tool_use', id: currentBlock.id, name: currentBlock.name, input: currentBlock.input });
